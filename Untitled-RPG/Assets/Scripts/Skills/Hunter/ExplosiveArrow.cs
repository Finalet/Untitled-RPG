...
public class ExplosiveArrow : Skill
{
    ...
    public void Shoot () {
        ...
        if (newArrow != null) newArrow.Shoot(strength, shootPoint, CalculateDamage.damageInfo(damageType, baseDamagePercentage, skillName, 1)); //could be null if just canceled skill
