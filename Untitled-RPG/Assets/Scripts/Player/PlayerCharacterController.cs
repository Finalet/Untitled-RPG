...
namespace ECM.Controllers
{
    ...
    public class PlayerCharacterController : MonoBehaviour
    {
        ...
        {
            get {
                return PlayerControlls.instance.isSprinting || PlayerControlls.instance.isRolling  ? _speed * 5 * speedMultiplier * Characteristics.instance.walkSpeed : _speed * speedMultiplier * Characteristics.instance.walkSpeed; 
            }
            set {
        ...
        protected virtual void HandleInput()
        {
            ...
            jump = Input.GetKey(KeybindsManager.instance.currentKeyBinds["Jump"]);
