	...
	SubShader
	{
		...
		Pass
		{
			...
			half4 frag ( VertexOutput IN  ) : SV_Target
			{
				...
				float2 uv02_g147 = IN.ase_texcoord7.xy * float2( 1,1 ) + float2( 0,0 );
				float temp_output_3_0_g147 = 3.0;
				...
				float2 uv02_g142 = IN.ase_texcoord7.xy * float2( 1,1 ) + float2( 0,0 );
				...
				float2 uv02_g145 = IN.ase_texcoord7.xy * float2( 1,1 ) + float2( 0,0 );
				float temp_output_3_0_g145 = 3.0;
				...
				float4 temp_output_155_0 = ( ( ( _Color1_Instance * ( ( ( 1.0 - step( uv02_g143.x , ( ( temp_output_3_0_g143 - 1.0 ) / temp_output_7_0_g143 ) ) ) * ( step( uv02_g143.x , ( temp_output_3_0_g143 / temp_output_7_0_g143 ) ) * 1.0 ) ) * ( ( 1.0 - step( uv02_g143.y , ( ( temp_output_9_0_g143 - 1.0 ) / temp_output_8_0_g143 ) ) ) * ( step( uv02_g143.y , ( temp_output_9_0_g143 / temp_output_8_0_g143 ) ) * 1.0 ) ) ) ) + ( _Color2_Instance * ( ( ( 1.0 - step( uv02_g141.x , ( ( temp_output_3_0_g141 - 1.0 ) / temp_output_7_0_g141 ) ) ) * ( step( uv02_g141.x , ( temp_output_3_0_g141 / temp_output_7_0_g141 ) ) * 1.0 ) ) * ( ( 1.0 - step( uv02_g141.y , ( ( temp_output_9_0_g141 - 1.0 ) / temp_output_8_0_g141 ) ) ) * ( step( uv02_g141.y , ( temp_output_9_0_g141 / temp_output_8_0_g141 ) ) * 1.0 ) ) ) ) + ( _Color3_Instance * ( ( ( 1.0 - step( uv02_g147.x , ( ( temp_output_3_0_g147 - 1.0 ) / temp_output_7_0_g147 ) ) ) * ( step( uv02_g147.x , ( temp_output_3_0_g147 / temp_output_7_0_g147 ) ) * 1.0 ) ) * ( ( 1.0 - step( uv02_g147.y , ( ( temp_output_9_0_g147 - 1.0 ) / temp_output_8_0_g147 ) ) ) * ( step( uv02_g147.y , ( temp_output_9_0_g147 / temp_output_8_0_g147 ) ) * 1.0 ) ) ) ) + ( _Color4_Instance * ( ( ( 1.0 - step( uv02_g142.x , ( ( temp_output_3_0_g142 - 1.0 ) / temp_output_7_0_g142 ) ) ) * ( step( uv02_g142.x , ( temp_output_3_0_g142 / temp_output_7_0_g142 ) ) * 1.0 ) ) * ( ( 1.0 - step( uv02_g142.y , ( ( temp_output_9_0_g142 - 1.0 ) / temp_output_8_0_g142 ) ) ) * ( step( uv02_g142.y , ( temp_output_9_0_g142 / temp_output_8_0_g142 ) ) * 1.0 ) ) ) ) ) + ( ( _Color5_Instance * ( ( ( 1.0 - step( uv02_g144.x , ( ( temp_output_3_0_g144 - 1.0 ) / temp_output_7_0_g144 ) ) ) * ( step( uv02_g144.x , ( temp_output_3_0_g144 / temp_output_7_0_g144 ) ) * 1.0 ) ) * ( ( 1.0 - step( uv02_g144.y , ( ( temp_output_9_0_g144 - 1.0 ) / temp_output_8_0_g144 ) ) ) * ( step( uv02_g144.y , ( temp_output_9_0_g144 / temp_output_8_0_g144 ) ) * 1.0 ) ) ) ) + ( _Color6_Instance * ( ( ( 1.0 - step( uv02_g146.x , ( ( temp_output_3_0_g146 - 1.0 ) / temp_output_7_0_g146 ) ) ) * ( step( uv02_g146.x , ( temp_output_3_0_g146 / temp_output_7_0_g146 ) ) * 1.0 ) ) * ( ( 1.0 - step( uv02_g146.y , ( ( temp_output_9_0_g146 - 1.0 ) / temp_output_8_0_g146 ) ) ) * ( step( uv02_g146.y , ( temp_output_9_0_g146 / temp_output_8_0_g146 ) ) * 1.0 ) ) ) ) + ( _Color7_Instance * ( ( ( 1.0 - step( uv02_g145.x , ( ( temp_output_3_0_g145 - 1.0 ) / temp_output_7_0_g145 ) ) ) * ( step( uv02_g145.x , ( temp_output_3_0_g145 / temp_output_7_0_g145 ) ) * 1.0 ) ) * ( ( 1.0 - step( uv02_g145.y , ( ( temp_output_9_0_g145 - 1.0 ) / temp_output_8_0_g145 ) ) ) * ( step( uv02_g145.y , ( temp_output_9_0_g145 / temp_output_8_0_g145 ) ) * 1.0 ) ) ) ) + ( _Color8_Instance * ( ( ( 1.0 - step( uv02_g148.x , ( ( temp_output_3_0_g148 - 1.0 ) / temp_output_7_0_g148 ) ) ) * ( step( uv02_g148.x , ( temp_output_3_0_g148 / temp_output_7_0_g148 ) ) * 1.0 ) ) * ( ( 1.0 - step( uv02_g148.y , ( ( temp_output_9_0_g148 - 1.0 ) / temp_output_8_0_g148 ) ) ) * ( step( uv02_g148.y , ( temp_output_9_0_g148 / temp_output_8_0_g148 ) ) * 1.0 ) ) ) ) ) );
		...
		Pass
		{
			...
			half4 frag(VertexOutput IN  ) : SV_TARGET
			{
				...
				float4 _Color1_Instance = UNITY_ACCESS_INSTANCED_PROP(MalbersColor4x2,_Color1);
				float2 uv02_g143 = IN.ase_texcoord.xy * float2( 1,1 ) + float2( 0,0 );
				float temp_output_3_0_g143 = 1.0;
				float temp_output_7_0_g143 = 4.0;
				float temp_output_9_0_g143 = 2.0;
				float temp_output_8_0_g143 = 2.0;
				float4 _Color2_Instance = UNITY_ACCESS_INSTANCED_PROP(MalbersColor4x2,_Color2);
				float2 uv02_g141 = IN.ase_texcoord.xy * float2( 1,1 ) + float2( 0,0 );
				float temp_output_3_0_g141 = 2.0;
				float temp_output_7_0_g141 = 4.0;
				float temp_output_9_0_g141 = 2.0;
				float temp_output_8_0_g141 = 2.0;
				float4 _Color3_Instance = UNITY_ACCESS_INSTANCED_PROP(MalbersColor4x2,_Color3);
				float2 uv02_g147 = IN.ase_texcoord.xy * float2( 1,1 ) + float2( 0,0 );
				float temp_output_3_0_g147 = 3.0;
				float temp_output_7_0_g147 = 4.0;
				float temp_output_9_0_g147 = 2.0;
				float temp_output_8_0_g147 = 2.0;
				float4 _Color4_Instance = UNITY_ACCESS_INSTANCED_PROP(MalbersColor4x2,_Color4);
				float2 uv02_g142 = IN.ase_texcoord.xy * float2( 1,1 ) + float2( 0,0 );
				float temp_output_3_0_g142 = 4.0;
				float temp_output_7_0_g142 = 4.0;
				float temp_output_9_0_g142 = 2.0;
				float temp_output_8_0_g142 = 2.0;
				float4 _Color5_Instance = UNITY_ACCESS_INSTANCED_PROP(MalbersColor4x2,_Color5);
				float2 uv02_g144 = IN.ase_texcoord.xy * float2( 1,1 ) + float2( 0,0 );
				float temp_output_3_0_g144 = 1.0;
				float temp_output_7_0_g144 = 4.0;
				float temp_output_9_0_g144 = 1.0;
				float temp_output_8_0_g144 = 2.0;
				float4 _Color6_Instance = UNITY_ACCESS_INSTANCED_PROP(MalbersColor4x2,_Color6);
				float2 uv02_g146 = IN.ase_texcoord.xy * float2( 1,1 ) + float2( 0,0 );
				float temp_output_3_0_g146 = 2.0;
				float temp_output_7_0_g146 = 4.0;
				float temp_output_9_0_g146 = 1.0;
				float temp_output_8_0_g146 = 2.0;
				float4 _Color7_Instance = UNITY_ACCESS_INSTANCED_PROP(MalbersColor4x2,_Color7);
				float2 uv02_g145 = IN.ase_texcoord.xy * float2( 1,1 ) + float2( 0,0 );
				float temp_output_3_0_g145 = 3.0;
				float temp_output_7_0_g145 = 4.0;
				float temp_output_9_0_g145 = 1.0;
				float temp_output_8_0_g145 = 2.0;
...
/*ASEBEGIN
Version=17600
53;193;1636;776;-1024.445;59.08173;1;True;True
...
Node;AmplifyShaderEditor.FunctionNode;162;133.8517,1424.481;Inherit;True;ColorShartSlot;-1;;148;231fe18505db4a84b9c478d379c9247d;0;5;38;COLOR;0.7843138,0.3137255,0,0;False;3;FLOAT;4;False;9;FLOAT;1;False;7;FLOAT;4;False;8;FLOAT;2;False;1;COLOR;0
Node;AmplifyShaderEditor.FunctionNode;151;121.5042,167.0022;Inherit;True;ColorShartSlot;-1;;147;231fe18505db4a84b9c478d379c9247d;0;5;38;COLOR;0.7843138,0.3137255,0,0;False;3;FLOAT;3;False;9;FLOAT;2;False;7;FLOAT;4;False;8;FLOAT;2;False;1;COLOR;0
Node;AmplifyShaderEditor.FunctionNode;161;133.3375,1181.325;Inherit;True;ColorShartSlot;-1;;145;231fe18505db4a84b9c478d379c9247d;0;5;38;COLOR;0.7843138,0.3137255,0,0;False;3;FLOAT;3;False;9;FLOAT;1;False;7;FLOAT;4;False;8;FLOAT;2;False;1;COLOR;0
Node;AmplifyShaderEditor.FunctionNode;160;119.8096,947.4603;Inherit;True;ColorShartSlot;-1;;146;231fe18505db4a84b9c478d379c9247d;0;5;38;COLOR;0.7843138,0.3137255,0,0;False;3;FLOAT;2;False;9;FLOAT;1;False;7;FLOAT;4;False;8;FLOAT;2;False;1;COLOR;0
Node;AmplifyShaderEditor.FunctionNode;145;115.9171,-326.2204;Inherit;True;ColorShartSlot;-1;;143;231fe18505db4a84b9c478d379c9247d;0;5;38;COLOR;0.7843138,0.3137255,0,0;False;3;FLOAT;1;False;9;FLOAT;2;False;7;FLOAT;4;False;8;FLOAT;2;False;1;COLOR;0
Node;AmplifyShaderEditor.FunctionNode;153;122.0185,410.1585;Inherit;True;ColorShartSlot;-1;;142;231fe18505db4a84b9c478d379c9247d;0;5;38;COLOR;0.7843138,0.3137255,0,0;False;3;FLOAT;4;False;9;FLOAT;2;False;7;FLOAT;4;False;8;FLOAT;2;False;1;COLOR;0
Node;AmplifyShaderEditor.FunctionNode;149;107.9764,-66.86263;Inherit;True;ColorShartSlot;-1;;141;231fe18505db4a84b9c478d379c9247d;0;5;38;COLOR;0.7843138,0.3137255,0,0;False;3;FLOAT;2;False;9;FLOAT;2;False;7;FLOAT;4;False;8;FLOAT;2;False;1;COLOR;0
Node;AmplifyShaderEditor.FunctionNode;163;127.7504,688.1025;Inherit;True;ColorShartSlot;-1;;144;231fe18505db4a84b9c478d379c9247d;0;5;38;COLOR;0.7843138,0.3137255,0,0;False;3;FLOAT;1;False;9;FLOAT;1;False;7;FLOAT;4;False;8;FLOAT;2;False;1;COLOR;0
...
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;185;2076.697,169.3291;Float;False;True;-1;2;UnityEditor.ShaderGraph.PBRMasterGUI;0;2;Malbers/Color4x2;94348b07e5e8bab40bd6c8a1e3df54cd;True;Forward;0;0;Forward;12;False;False;False;True;0;False;-1;False;False;False;False;False;True;3;RenderPipeline=UniversalPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;True;2;0;True;1;1;False;-1;0;False;-1;1;1;False;-1;0;False;-1;False;False;False;True;True;True;True;True;0;False;-1;True;False;255;False;-1;255;False;-1;255;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;True;1;False;-1;True;3;False;-1;True;True;0;False;-1;0;False;-1;True;1;LightMode=UniversalForward;False;0;Hidden/InternalErrorShader;0;0;Standard;12;Workflow;1;Surface;0;  Blend;0;Two Sided;1;Cast Shadows;1;Receive Shadows;1;GPU Instancing;1;LOD CrossFade;1;Built-in Fog;1;Meta Pass;1;Override Baked GI;0;Vertex Position,InvertActionOnDeselection;1;0;5;True;True;True;True;True;False;;0
...
ASEEND*/
//CHKSM=C5F58DC1CD1376307546EEFC46192A6306ADAD52