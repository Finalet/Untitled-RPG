// Upgrade NOTE: upgraded instancing buffer 'MalbersColor4x2OneSide' to new syntax.
...
#define _Color1_arr MalbersColor4x2OneSide
			UNITY_DEFINE_INSTANCED_PROP(float4, _Color2)
#define _Color2_arr MalbersColor4x2OneSide
			UNITY_DEFINE_INSTANCED_PROP(float4, _Color3)
#define _Color3_arr MalbersColor4x2OneSide
			UNITY_DEFINE_INSTANCED_PROP(float4, _Color4)
#define _Color4_arr MalbersColor4x2OneSide
			UNITY_DEFINE_INSTANCED_PROP(float4, _Color5)
#define _Color5_arr MalbersColor4x2OneSide
			UNITY_DEFINE_INSTANCED_PROP(float4, _Color6)
#define _Color6_arr MalbersColor4x2OneSide
			UNITY_DEFINE_INSTANCED_PROP(float4, _Color7)
#define _Color7_arr MalbersColor4x2OneSide
			UNITY_DEFINE_INSTANCED_PROP(float4, _Color8)
#define _Color8_arr MalbersColor4x2OneSide
		...
		void surf( Input i , inout SurfaceOutputStandard o )
		{
			...
			float temp_output_3_0_g138 = 1.0;
			float temp_output_7_0_g138 = 4.0;
			float temp_output_9_0_g138 = 2.0;
			float temp_output_8_0_g138 = 2.0;
			...
			float temp_output_3_0_g140 = 4.0;
			float temp_output_7_0_g140 = 4.0;
			float temp_output_9_0_g140 = 2.0;
			float temp_output_8_0_g140 = 2.0;
			float4 _Color5_Instance = UNITY_ACCESS_INSTANCED_PROP(_Color5_arr, _Color5);
			float temp_output_3_0_g139 = 1.0;
			float temp_output_7_0_g139 = 4.0;
			float temp_output_9_0_g139 = 1.0;
			float temp_output_8_0_g139 = 2.0;
			float4 _Color6_Instance = UNITY_ACCESS_INSTANCED_PROP(_Color6_arr, _Color6);
			float temp_output_3_0_g135 = 2.0;
			...
			float temp_output_3_0_g137 = 4.0;
			float temp_output_7_0_g137 = 4.0;
			float temp_output_9_0_g137 = 1.0;
			float temp_output_8_0_g137 = 2.0;
			float4 temp_output_155_0 = ( ( ( _Color1_Instance * ( ( ( 1.0 - step( i.uv_texcoord.x , ( ( temp_output_3_0_g138 - 1.0 ) / temp_output_7_0_g138 ) ) ) * ( step( i.uv_texcoord.x , ( temp_output_3_0_g138 / temp_output_7_0_g138 ) ) * 1.0 ) ) * ( ( 1.0 - step( i.uv_texcoord.y , ( ( temp_output_9_0_g138 - 1.0 ) / temp_output_8_0_g138 ) ) ) * ( step( i.uv_texcoord.y , ( temp_output_9_0_g138 / temp_output_8_0_g138 ) ) * 1.0 ) ) ) ) + ( _Color2_Instance * ( ( ( 1.0 - step( i.uv_texcoord.x , ( ( temp_output_3_0_g141 - 1.0 ) / temp_output_7_0_g141 ) ) ) * ( step( i.uv_texcoord.x , ( temp_output_3_0_g141 / temp_output_7_0_g141 ) ) * 1.0 ) ) * ( ( 1.0 - step( i.uv_texcoord.y , ( ( temp_output_9_0_g141 - 1.0 ) / temp_output_8_0_g141 ) ) ) * ( step( i.uv_texcoord.y , ( temp_output_9_0_g141 / temp_output_8_0_g141 ) ) * 1.0 ) ) ) ) + ( _Color3_Instance * ( ( ( 1.0 - step( i.uv_texcoord.x , ( ( temp_output_3_0_g134 - 1.0 ) / temp_output_7_0_g134 ) ) ) * ( step( i.uv_texcoord.x , ( temp_output_3_0_g134 / temp_output_7_0_g134 ) ) * 1.0 ) ) * ( ( 1.0 - step( i.uv_texcoord.y , ( ( temp_output_9_0_g134 - 1.0 ) / temp_output_8_0_g134 ) ) ) * ( step( i.uv_texcoord.y , ( temp_output_9_0_g134 / temp_output_8_0_g134 ) ) * 1.0 ) ) ) ) + ( _Color4_Instance * ( ( ( 1.0 - step( i.uv_texcoord.x , ( ( temp_output_3_0_g140 - 1.0 ) / temp_output_7_0_g140 ) ) ) * ( step( i.uv_texcoord.x , ( temp_output_3_0_g140 / temp_output_7_0_g140 ) ) * 1.0 ) ) * ( ( 1.0 - step( i.uv_texcoord.y , ( ( temp_output_9_0_g140 - 1.0 ) / temp_output_8_0_g140 ) ) ) * ( step( i.uv_texcoord.y , ( temp_output_9_0_g140 / temp_output_8_0_g140 ) ) * 1.0 ) ) ) ) ) + ( ( _Color5_Instance * ( ( ( 1.0 - step( i.uv_texcoord.x , ( ( temp_output_3_0_g139 - 1.0 ) / temp_output_7_0_g139 ) ) ) * ( step( i.uv_texcoord.x , ( temp_output_3_0_g139 / temp_output_7_0_g139 ) ) * 1.0 ) ) * ( ( 1.0 - step( i.uv_texcoord.y , ( ( temp_output_9_0_g139 - 1.0 ) / temp_output_8_0_g139 ) ) ) * ( step( i.uv_texcoord.y , ( temp_output_9_0_g139 / temp_output_8_0_g139 ) ) * 1.0 ) ) ) ) + ( _Color6_Instance * ( ( ( 1.0 - step( i.uv_texcoord.x , ( ( temp_output_3_0_g135 - 1.0 ) / temp_output_7_0_g135 ) ) ) * ( step( i.uv_texcoord.x , ( temp_output_3_0_g135 / temp_output_7_0_g135 ) ) * 1.0 ) ) * ( ( 1.0 - step( i.uv_texcoord.y , ( ( temp_output_9_0_g135 - 1.0 ) / temp_output_8_0_g135 ) ) ) * ( step( i.uv_texcoord.y , ( temp_output_9_0_g135 / temp_output_8_0_g135 ) ) * 1.0 ) ) ) ) + ( _Color7_Instance * ( ( ( 1.0 - step( i.uv_texcoord.x , ( ( temp_output_3_0_g136 - 1.0 ) / temp_output_7_0_g136 ) ) ) * ( step( i.uv_texcoord.x , ( temp_output_3_0_g136 / temp_output_7_0_g136 ) ) * 1.0 ) ) * ( ( 1.0 - step( i.uv_texcoord.y , ( ( temp_output_9_0_g136 - 1.0 ) / temp_output_8_0_g136 ) ) ) * ( step( i.uv_texcoord.y , ( temp_output_9_0_g136 / temp_output_8_0_g136 ) ) * 1.0 ) ) ) ) + ( _Color8_Instance * ( ( ( 1.0 - step( i.uv_texcoord.x , ( ( temp_output_3_0_g137 - 1.0 ) / temp_output_7_0_g137 ) ) ) * ( step( i.uv_texcoord.x , ( temp_output_3_0_g137 / temp_output_7_0_g137 ) ) * 1.0 ) ) * ( ( 1.0 - step( i.uv_texcoord.y , ( ( temp_output_9_0_g137 - 1.0 ) / temp_output_8_0_g137 ) ) ) * ( step( i.uv_texcoord.y , ( temp_output_9_0_g137 / temp_output_8_0_g137 ) ) * 1.0 ) ) ) ) ) );
...
/*ASEBEGIN
Version=16200
81;249;1309;794;828.1517;504.4048;2.726909;True;True
...
Node;AmplifyShaderEditor.FunctionNode;153;122.0185,410.1585;Float;True;ColorShartSlot;-1;;140;231fe18505db4a84b9c478d379c9247d;0;5;38;COLOR;0.7843138,0.3137255,0,0;False;3;FLOAT;4;False;9;FLOAT;2;False;7;FLOAT;4;False;8;FLOAT;2;False;1;COLOR;0
Node;AmplifyShaderEditor.FunctionNode;163;127.7504,688.1025;Float;True;ColorShartSlot;-1;;139;231fe18505db4a84b9c478d379c9247d;0;5;38;COLOR;0.7843138,0.3137255,0,0;False;3;FLOAT;1;False;9;FLOAT;1;False;7;FLOAT;4;False;8;FLOAT;2;False;1;COLOR;0
Node;AmplifyShaderEditor.FunctionNode;145;115.9171,-326.2204;Float;True;ColorShartSlot;-1;;138;231fe18505db4a84b9c478d379c9247d;0;5;38;COLOR;0.7843138,0.3137255,0,0;False;3;FLOAT;1;False;9;FLOAT;2;False;7;FLOAT;4;False;8;FLOAT;2;False;1;COLOR;0
Node;AmplifyShaderEditor.FunctionNode;162;133.8517,1424.481;Float;True;ColorShartSlot;-1;;137;231fe18505db4a84b9c478d379c9247d;0;5;38;COLOR;0.7843138,0.3137255,0,0;False;3;FLOAT;4;False;9;FLOAT;1;False;7;FLOAT;4;False;8;FLOAT;2;False;1;COLOR;0
...
Node;AmplifyShaderEditor.FunctionNode;160;119.8096,947.4603;Float;True;ColorShartSlot;-1;;135;231fe18505db4a84b9c478d379c9247d;0;5;38;COLOR;0.7843138,0.3137255,0,0;False;3;FLOAT;2;False;9;FLOAT;1;False;7;FLOAT;4;False;8;FLOAT;2;False;1;COLOR;0
...
ASEEND*/
//CHKSM=5780D5838AF5E85F5415187D0C77AEAC53AC6FA8