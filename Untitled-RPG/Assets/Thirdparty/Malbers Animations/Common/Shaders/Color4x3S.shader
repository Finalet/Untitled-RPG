	...
	SubShader
	{
		...
		Pass
		{
			...
			half4 frag ( VertexOutput IN  ) : SV_Target
			{
				...
				float2 uv02_g205 = IN.ase_texcoord7.xy * float2( 1,1 ) + float2( 0,0 );
				float temp_output_3_0_g205 = 1.0;
				float temp_output_7_0_g205 = 4.0;
				float temp_output_9_0_g205 = 3.0;
				float temp_output_8_0_g205 = 3.0;
				float2 uv02_g206 = IN.ase_texcoord7.xy * float2( 1,1 ) + float2( 0,0 );
				float temp_output_3_0_g206 = 2.0;
				float temp_output_7_0_g206 = 4.0;
				float temp_output_9_0_g206 = 3.0;
				float temp_output_8_0_g206 = 3.0;
				float2 uv02_g202 = IN.ase_texcoord7.xy * float2( 1,1 ) + float2( 0,0 );
				float temp_output_3_0_g202 = 3.0;
				float temp_output_7_0_g202 = 4.0;
				float temp_output_9_0_g202 = 3.0;
				float temp_output_8_0_g202 = 3.0;
				float2 uv02_g211 = IN.ase_texcoord7.xy * float2( 1,1 ) + float2( 0,0 );
				float temp_output_3_0_g211 = 4.0;
				float temp_output_7_0_g211 = 4.0;
				float temp_output_9_0_g211 = 3.0;
				float temp_output_8_0_g211 = 3.0;
				float2 uv02_g208 = IN.ase_texcoord7.xy * float2( 1,1 ) + float2( 0,0 );
				float temp_output_3_0_g208 = 1.0;
				float temp_output_7_0_g208 = 4.0;
				float temp_output_9_0_g208 = 2.0;
				float temp_output_8_0_g208 = 3.0;
				float2 uv02_g204 = IN.ase_texcoord7.xy * float2( 1,1 ) + float2( 0,0 );
				float temp_output_3_0_g204 = 2.0;
				float temp_output_7_0_g204 = 4.0;
				float temp_output_9_0_g204 = 2.0;
				float temp_output_8_0_g204 = 3.0;
				float2 uv02_g203 = IN.ase_texcoord7.xy * float2( 1,1 ) + float2( 0,0 );
				float temp_output_3_0_g203 = 3.0;
				float temp_output_7_0_g203 = 4.0;
				float temp_output_9_0_g203 = 2.0;
				float temp_output_8_0_g203 = 3.0;
				float2 uv02_g201 = IN.ase_texcoord7.xy * float2( 1,1 ) + float2( 0,0 );
				float temp_output_3_0_g201 = 4.0;
				float temp_output_7_0_g201 = 4.0;
				float temp_output_9_0_g201 = 2.0;
				float temp_output_8_0_g201 = 3.0;
				float2 uv02_g209 = IN.ase_texcoord7.xy * float2( 1,1 ) + float2( 0,0 );
				float temp_output_3_0_g209 = 1.0;
				float temp_output_7_0_g209 = 4.0;
				float temp_output_9_0_g209 = 1.0;
				float temp_output_8_0_g209 = 3.0;
				float2 uv02_g210 = IN.ase_texcoord7.xy * float2( 1,1 ) + float2( 0,0 );
				float temp_output_3_0_g210 = 2.0;
				float temp_output_7_0_g210 = 4.0;
				float temp_output_9_0_g210 = 1.0;
				float temp_output_8_0_g210 = 3.0;
				float2 uv02_g197 = IN.ase_texcoord7.xy * float2( 1,1 ) + float2( 0,0 );
				float temp_output_3_0_g197 = 3.0;
				float temp_output_7_0_g197 = 4.0;
				float temp_output_9_0_g197 = 1.0;
				float temp_output_8_0_g197 = 3.0;
				float2 uv02_g207 = IN.ase_texcoord7.xy * float2( 1,1 ) + float2( 0,0 );
				float temp_output_3_0_g207 = 4.0;
				float temp_output_7_0_g207 = 4.0;
				float temp_output_9_0_g207 = 1.0;
				float temp_output_8_0_g207 = 3.0;
				float4 temp_output_155_0 = ( ( ( _Color1 * ( ( ( 1.0 - step( uv02_g205.x , ( ( temp_output_3_0_g205 - 1.0 ) / temp_output_7_0_g205 ) ) ) * ( step( uv02_g205.x , ( temp_output_3_0_g205 / temp_output_7_0_g205 ) ) * 1.0 ) ) * ( ( 1.0 - step( uv02_g205.y , ( ( temp_output_9_0_g205 - 1.0 ) / temp_output_8_0_g205 ) ) ) * ( step( uv02_g205.y , ( temp_output_9_0_g205 / temp_output_8_0_g205 ) ) * 1.0 ) ) ) ) + ( _Color2 * ( ( ( 1.0 - step( uv02_g206.x , ( ( temp_output_3_0_g206 - 1.0 ) / temp_output_7_0_g206 ) ) ) * ( step( uv02_g206.x , ( temp_output_3_0_g206 / temp_output_7_0_g206 ) ) * 1.0 ) ) * ( ( 1.0 - step( uv02_g206.y , ( ( temp_output_9_0_g206 - 1.0 ) / temp_output_8_0_g206 ) ) ) * ( step( uv02_g206.y , ( temp_output_9_0_g206 / temp_output_8_0_g206 ) ) * 1.0 ) ) ) ) + ( _Color3 * ( ( ( 1.0 - step( uv02_g202.x , ( ( temp_output_3_0_g202 - 1.0 ) / temp_output_7_0_g202 ) ) ) * ( step( uv02_g202.x , ( temp_output_3_0_g202 / temp_output_7_0_g202 ) ) * 1.0 ) ) * ( ( 1.0 - step( uv02_g202.y , ( ( temp_output_9_0_g202 - 1.0 ) / temp_output_8_0_g202 ) ) ) * ( step( uv02_g202.y , ( temp_output_9_0_g202 / temp_output_8_0_g202 ) ) * 1.0 ) ) ) ) + ( _Color4 * ( ( ( 1.0 - step( uv02_g211.x , ( ( temp_output_3_0_g211 - 1.0 ) / temp_output_7_0_g211 ) ) ) * ( step( uv02_g211.x , ( temp_output_3_0_g211 / temp_output_7_0_g211 ) ) * 1.0 ) ) * ( ( 1.0 - step( uv02_g211.y , ( ( temp_output_9_0_g211 - 1.0 ) / temp_output_8_0_g211 ) ) ) * ( step( uv02_g211.y , ( temp_output_9_0_g211 / temp_output_8_0_g211 ) ) * 1.0 ) ) ) ) ) + ( ( _Color5 * ( ( ( 1.0 - step( uv02_g208.x , ( ( temp_output_3_0_g208 - 1.0 ) / temp_output_7_0_g208 ) ) ) * ( step( uv02_g208.x , ( temp_output_3_0_g208 / temp_output_7_0_g208 ) ) * 1.0 ) ) * ( ( 1.0 - step( uv02_g208.y , ( ( temp_output_9_0_g208 - 1.0 ) / temp_output_8_0_g208 ) ) ) * ( step( uv02_g208.y , ( temp_output_9_0_g208 / temp_output_8_0_g208 ) ) * 1.0 ) ) ) ) + ( _Color6 * ( ( ( 1.0 - step( uv02_g204.x , ( ( temp_output_3_0_g204 - 1.0 ) / temp_output_7_0_g204 ) ) ) * ( step( uv02_g204.x , ( temp_output_3_0_g204 / temp_output_7_0_g204 ) ) * 1.0 ) ) * ( ( 1.0 - step( uv02_g204.y , ( ( temp_output_9_0_g204 - 1.0 ) / temp_output_8_0_g204 ) ) ) * ( step( uv02_g204.y , ( temp_output_9_0_g204 / temp_output_8_0_g204 ) ) * 1.0 ) ) ) ) + ( _Color7 * ( ( ( 1.0 - step( uv02_g203.x , ( ( temp_output_3_0_g203 - 1.0 ) / temp_output_7_0_g203 ) ) ) * ( step( uv02_g203.x , ( temp_output_3_0_g203 / temp_output_7_0_g203 ) ) * 1.0 ) ) * ( ( 1.0 - step( uv02_g203.y , ( ( temp_output_9_0_g203 - 1.0 ) / temp_output_8_0_g203 ) ) ) * ( step( uv02_g203.y , ( temp_output_9_0_g203 / temp_output_8_0_g203 ) ) * 1.0 ) ) ) ) + ( _Color8 * ( ( ( 1.0 - step( uv02_g201.x , ( ( temp_output_3_0_g201 - 1.0 ) / temp_output_7_0_g201 ) ) ) * ( step( uv02_g201.x , ( temp_output_3_0_g201 / temp_output_7_0_g201 ) ) * 1.0 ) ) * ( ( 1.0 - step( uv02_g201.y , ( ( temp_output_9_0_g201 - 1.0 ) / temp_output_8_0_g201 ) ) ) * ( step( uv02_g201.y , ( temp_output_9_0_g201 / temp_output_8_0_g201 ) ) * 1.0 ) ) ) ) ) + ( ( _Color9 * ( ( ( 1.0 - step( uv02_g209.x , ( ( temp_output_3_0_g209 - 1.0 ) / temp_output_7_0_g209 ) ) ) * ( step( uv02_g209.x , ( temp_output_3_0_g209 / temp_output_7_0_g209 ) ) * 1.0 ) ) * ( ( 1.0 - step( uv02_g209.y , ( ( temp_output_9_0_g209 - 1.0 ) / temp_output_8_0_g209 ) ) ) * ( step( uv02_g209.y , ( temp_output_9_0_g209 / temp_output_8_0_g209 ) ) * 1.0 ) ) ) ) + ( _Color10 * ( ( ( 1.0 - step( uv02_g210.x , ( ( temp_output_3_0_g210 - 1.0 ) / temp_output_7_0_g210 ) ) ) * ( step( uv02_g210.x , ( temp_output_3_0_g210 / temp_output_7_0_g210 ) ) * 1.0 ) ) * ( ( 1.0 - step( uv02_g210.y , ( ( temp_output_9_0_g210 - 1.0 ) / temp_output_8_0_g210 ) ) ) * ( step( uv02_g210.y , ( temp_output_9_0_g210 / temp_output_8_0_g210 ) ) * 1.0 ) ) ) ) + ( _Color11 * ( ( ( 1.0 - step( uv02_g197.x , ( ( temp_output_3_0_g197 - 1.0 ) / temp_output_7_0_g197 ) ) ) * ( step( uv02_g197.x , ( temp_output_3_0_g197 / temp_output_7_0_g197 ) ) * 1.0 ) ) * ( ( 1.0 - step( uv02_g197.y , ( ( temp_output_9_0_g197 - 1.0 ) / temp_output_8_0_g197 ) ) ) * ( step( uv02_g197.y , ( temp_output_9_0_g197 / temp_output_8_0_g197 ) ) * 1.0 ) ) ) ) + ( _Color12 * ( ( ( 1.0 - step( uv02_g207.x , ( ( temp_output_3_0_g207 - 1.0 ) / temp_output_7_0_g207 ) ) ) * ( step( uv02_g207.x , ( temp_output_3_0_g207 / temp_output_7_0_g207 ) ) * 1.0 ) ) * ( ( 1.0 - step( uv02_g207.y , ( ( temp_output_9_0_g207 - 1.0 ) / temp_output_8_0_g207 ) ) ) * ( step( uv02_g207.y , ( temp_output_9_0_g207 / temp_output_8_0_g207 ) ) * 1.0 ) ) ) ) ) );
		...
		Pass
		{
			...
			half4 frag(VertexOutput IN  ) : SV_TARGET
			{
				...
				float2 uv02_g205 = IN.ase_texcoord.xy * float2( 1,1 ) + float2( 0,0 );
				float temp_output_3_0_g205 = 1.0;
				float temp_output_7_0_g205 = 4.0;
				float temp_output_9_0_g205 = 3.0;
				float temp_output_8_0_g205 = 3.0;
				float2 uv02_g206 = IN.ase_texcoord.xy * float2( 1,1 ) + float2( 0,0 );
				float temp_output_3_0_g206 = 2.0;
				float temp_output_7_0_g206 = 4.0;
				float temp_output_9_0_g206 = 3.0;
				float temp_output_8_0_g206 = 3.0;
				float2 uv02_g202 = IN.ase_texcoord.xy * float2( 1,1 ) + float2( 0,0 );
				float temp_output_3_0_g202 = 3.0;
				float temp_output_7_0_g202 = 4.0;
				float temp_output_9_0_g202 = 3.0;
				float temp_output_8_0_g202 = 3.0;
				float2 uv02_g211 = IN.ase_texcoord.xy * float2( 1,1 ) + float2( 0,0 );
				float temp_output_3_0_g211 = 4.0;
				float temp_output_7_0_g211 = 4.0;
				float temp_output_9_0_g211 = 3.0;
				float temp_output_8_0_g211 = 3.0;
				float2 uv02_g208 = IN.ase_texcoord.xy * float2( 1,1 ) + float2( 0,0 );
				float temp_output_3_0_g208 = 1.0;
				float temp_output_7_0_g208 = 4.0;
				float temp_output_9_0_g208 = 2.0;
				float temp_output_8_0_g208 = 3.0;
				float2 uv02_g204 = IN.ase_texcoord.xy * float2( 1,1 ) + float2( 0,0 );
				float temp_output_3_0_g204 = 2.0;
				float temp_output_7_0_g204 = 4.0;
				float temp_output_9_0_g204 = 2.0;
				float temp_output_8_0_g204 = 3.0;
				float2 uv02_g203 = IN.ase_texcoord.xy * float2( 1,1 ) + float2( 0,0 );
				float temp_output_3_0_g203 = 3.0;
				float temp_output_7_0_g203 = 4.0;
				float temp_output_9_0_g203 = 2.0;
				float temp_output_8_0_g203 = 3.0;
				...
				float temp_output_9_0_g201 = 2.0;
				float temp_output_8_0_g201 = 3.0;
				float2 uv02_g209 = IN.ase_texcoord.xy * float2( 1,1 ) + float2( 0,0 );
				float temp_output_3_0_g209 = 1.0;
				float temp_output_7_0_g209 = 4.0;
				float temp_output_9_0_g209 = 1.0;
				float temp_output_8_0_g209 = 3.0;
				float2 uv02_g210 = IN.ase_texcoord.xy * float2( 1,1 ) + float2( 0,0 );
				float temp_output_3_0_g210 = 2.0;
				float temp_output_7_0_g210 = 4.0;
				float temp_output_9_0_g210 = 1.0;
				float temp_output_8_0_g210 = 3.0;
				...
				float temp_output_9_0_g197 = 1.0;
				float temp_output_8_0_g197 = 3.0;
				float2 uv02_g207 = IN.ase_texcoord.xy * float2( 1,1 ) + float2( 0,0 );
				float temp_output_3_0_g207 = 4.0;
				float temp_output_7_0_g207 = 4.0;
				float temp_output_9_0_g207 = 1.0;
				float temp_output_8_0_g207 = 3.0;
...
/*ASEBEGIN
Version=17600
53;193;1636;776;-1012.232;57.81881;1.107828;True;True
...
Node;AmplifyShaderEditor.FunctionNode;163;127.7504,688.1025;Inherit;True;ColorShartSlot;-1;;208;231fe18505db4a84b9c478d379c9247d;0;5;38;COLOR;0.7843138,0.3137255,0,0;False;3;FLOAT;1;False;9;FLOAT;2;False;7;FLOAT;4;False;8;FLOAT;3;False;1;COLOR;0
Node;AmplifyShaderEditor.FunctionNode;153;122.0185,410.1585;Inherit;True;ColorShartSlot;-1;;211;231fe18505db4a84b9c478d379c9247d;0;5;38;COLOR;0.7843138,0.3137255,0,0;False;3;FLOAT;4;False;9;FLOAT;3;False;7;FLOAT;4;False;8;FLOAT;3;False;1;COLOR;0
Node;AmplifyShaderEditor.FunctionNode;186;186.9198,1938.3;Inherit;True;ColorShartSlot;-1;;210;231fe18505db4a84b9c478d379c9247d;0;5;38;COLOR;0.7843138,0.3137255,0,0;False;3;FLOAT;2;False;9;FLOAT;1;False;7;FLOAT;4;False;8;FLOAT;3;False;1;COLOR;0
Node;AmplifyShaderEditor.FunctionNode;184;194.8606,1678.942;Inherit;True;ColorShartSlot;-1;;209;231fe18505db4a84b9c478d379c9247d;0;5;38;COLOR;0.7843138,0.3137255,0,0;False;3;FLOAT;1;False;9;FLOAT;1;False;7;FLOAT;4;False;8;FLOAT;3;False;1;COLOR;0
Node;AmplifyShaderEditor.FunctionNode;190;200.9619,2415.321;Inherit;True;ColorShartSlot;-1;;207;231fe18505db4a84b9c478d379c9247d;0;5;38;COLOR;0.7843138,0.3137255,0,0;False;3;FLOAT;4;False;9;FLOAT;1;False;7;FLOAT;4;False;8;FLOAT;3;False;1;COLOR;0
Node;AmplifyShaderEditor.FunctionNode;149;107.9764,-66.86263;Inherit;True;ColorShartSlot;-1;;206;231fe18505db4a84b9c478d379c9247d;0;5;38;COLOR;0.7843138,0.3137255,0,0;False;3;FLOAT;2;False;9;FLOAT;3;False;7;FLOAT;4;False;8;FLOAT;3;False;1;COLOR;0
Node;AmplifyShaderEditor.FunctionNode;160;119.8096,947.4603;Inherit;True;ColorShartSlot;-1;;204;231fe18505db4a84b9c478d379c9247d;0;5;38;COLOR;0.7843138,0.3137255,0,0;False;3;FLOAT;2;False;9;FLOAT;2;False;7;FLOAT;4;False;8;FLOAT;3;False;1;COLOR;0
Node;AmplifyShaderEditor.FunctionNode;161;133.3375,1181.325;Inherit;True;ColorShartSlot;-1;;203;231fe18505db4a84b9c478d379c9247d;0;5;38;COLOR;0.7843138,0.3137255,0,0;False;3;FLOAT;3;False;9;FLOAT;2;False;7;FLOAT;4;False;8;FLOAT;3;False;1;COLOR;0
Node;AmplifyShaderEditor.FunctionNode;151;121.5042,167.0022;Inherit;True;ColorShartSlot;-1;;202;231fe18505db4a84b9c478d379c9247d;0;5;38;COLOR;0.7843138,0.3137255,0,0;False;3;FLOAT;3;False;9;FLOAT;3;False;7;FLOAT;4;False;8;FLOAT;3;False;1;COLOR;0
Node;AmplifyShaderEditor.FunctionNode;162;133.8517,1424.481;Inherit;True;ColorShartSlot;-1;;201;231fe18505db4a84b9c478d379c9247d;0;5;38;COLOR;0.7843138,0.3137255,0,0;False;3;FLOAT;4;False;9;FLOAT;2;False;7;FLOAT;4;False;8;FLOAT;3;False;1;COLOR;0
Node;AmplifyShaderEditor.FunctionNode;188;200.4478,2172.165;Inherit;True;ColorShartSlot;-1;;197;231fe18505db4a84b9c478d379c9247d;0;5;38;COLOR;0.7843138,0.3137255,0,0;False;3;FLOAT;3;False;9;FLOAT;1;False;7;FLOAT;4;False;8;FLOAT;3;False;1;COLOR;0
Node;AmplifyShaderEditor.FunctionNode;145;115.9171,-326.2204;Inherit;True;ColorShartSlot;-1;;205;231fe18505db4a84b9c478d379c9247d;0;5;38;COLOR;0.7843138,0.3137255,0,0;False;3;FLOAT;1;False;9;FLOAT;3;False;7;FLOAT;4;False;8;FLOAT;3;False;1;COLOR;0
...
ASEEND*/
//CHKSM=3F00963FA964B2DA217165CF6672795B2B59C076