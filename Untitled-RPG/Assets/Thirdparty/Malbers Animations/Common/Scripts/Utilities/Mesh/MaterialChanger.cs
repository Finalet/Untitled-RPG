...
//---------------------FINALE METHODS---------------------//
        /// <summary>
        /// Set an external material to a specific item
        /// </summary>
        /// <param name="itemName">the Name used for the MaterialItem</param>
        /// <param name="material">the material to set</param>
        public virtual void SetItemMaterial (string itemName, Material material) {
            MaterialItem mat = materialList.Find(item => item.Name == itemName);
            mat.ChangeMaterial(material);
        }
        /// <summary>
        /// Get specific item's material at an index.
        /// </summary>
        /// <param name="itemName">the Name used for the MaterialItem</param>
        /// <param name="index">which material to get</param>
        /// <returns></returns>
        public virtual Material getItemMaterial (string itemName, int index = 0) {
            MaterialItem mat = materialList.Find(item => item.Name == itemName);
            return mat.materials[index];
        }
