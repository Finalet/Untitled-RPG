...
namespace Crest
{
    ...
    internal class UnderwaterMaskPassHDRP : CustomPass
    {
        ...
        protected override void Execute(CustomPassContext context)
        {
            ...
            CoreUtils.ClearRenderTarget(commandBuffer, ClearFlag.All, Color.white * UnderwaterRenderer.UNDERWATER_MASK_NO_MASK);
            ...
            UnderwaterRenderer.PopulateOceanMask(commandBuffer, camera, OceanRenderer.Instance.Tiles,
                _cameraFrustumPlanes, _oceanMaskMaterial, debugDisableOceanMask);
        }
    }
}
