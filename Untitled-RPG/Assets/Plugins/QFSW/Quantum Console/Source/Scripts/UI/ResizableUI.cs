...
namespace QFSW.QC.UI
{
    ...
    public class ResizableUI : MonoBehaviour, IDragHandler
    {
        ...
        public void OnDrag(PointerEventData eventData)
        {
            ...
            Vector2 onlyX = deltaBounded;
            onlyX.y = 0;

            Vector2 onlyY = deltaBounded;
            onlyY.x = 0;

            _resizeRoot.offsetMax += onlyX / _resizeCanvas.scaleFactor;
            _resizeRoot.offsetMin += onlyY / _resizeCanvas.scaleFactor;
        }
    }
}
