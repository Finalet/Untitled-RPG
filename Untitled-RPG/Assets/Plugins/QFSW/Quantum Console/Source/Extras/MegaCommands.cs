...
namespace QFSW.QC.Extras
{
    public static class MegaCommands
    {
        ...
        private static object CallInstance(Type classType, string funcName)
        {
            return CallInstance(classType, funcName, MonoTargetType.Single, Array.Empty<string>());
        }

        [Command("call-instance")]
        private static object CallInstance(Type classType, string funcName, string[] args)
        {
            return CallInstance(classType, funcName, MonoTargetType.Single, args);
        }
