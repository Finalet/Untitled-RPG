...
_TerrainNormalmapTexture("InstancedPerPixelNormal", 2D) = "bump" {}
   ...
   SubShader {
      Tags{"RenderPipeline"="LightweightPipeline" "RenderType" = "Opaque" "Queue" = "Geometry+100" "IgnoreProjector" = "False" "SplatCount" = "20"}
      ...
      #define _VSGRASSMAP 1
      #define _VSSHADOWMAP 1
      #define _VSSHADOWTAPMEDIUM 1
...
GraphVertexInput ApplyMeshModification(inout GraphVertexInput input)
{
   ...
   Dependency "BaseMapShader" = "Hidden/MicroSplat/Terrain_Base293425932"
